...
i686-elf-gcc -m32 -ffreestanding -fno-pie -c Kernel/interruptHandlers/handlers.c -o handlers.o


i686-elf-ld -T linker.ld --oformat binary -o kernel.bin kernel.o irq.o kernel_entry.o idt.o pic.o std.o handlers.o
