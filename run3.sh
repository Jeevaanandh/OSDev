...
i686-elf-gcc -m32 -ffreestanding -fno-pie -c Kernel/idt.c -o idt.o
i686-elf-gcc -m32 -ffreestanding -fno-pie -c Kernel/pic.c -o pic.o


i686-elf-ld -T linker.ld --oformat binary -o kernel.bin kernel.o kernel_entry.o idt.o pic.o
